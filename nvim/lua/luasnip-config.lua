...
require("luasnip.loaders.from_vscode").lazy_load({paths= "~/.config/nvim/VscOdooSnippets"})
...
--require("luasnip.loaders.from_vscode").lazy_load {"~/.config/nvim/vscode-snippets"}
--require("luasnip.loaders.from_vscode").lazy_load {"~/.config/nvim/vscode-snippets"}

...
Plug 'beauwilliams/nvim-tree.lua'
...
Plug 'L3MON4D3/LuaSnip', {'tag': '1.1.0'}
...
"autocmd FileType xml setlocal shiftwidth=1 tabstop=2 softtabstop=2
...
nmap <leader>tt <C-w>s<C-w>j:terminal<CR>:set nonumber<CR><S-a>
